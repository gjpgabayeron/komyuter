...
| **⚠️ Coordinate Order Rule (Critical)** ALL coordinate pairs in this system follow GeoJSON standard: [longitude, latitude]. PostGIS ST_MakePoint(), GeoJSON, and the map renderer (MapLibre GL JS) all expect [lng, lat]. There is no exception and no conversion layer — a swapped pair places stops in the ocean. This is the single most dangerous pitfall in this codebase. |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
